...
for the parsing of JSON data:
    app.use(express.json())
// TODO: Implement middleware for parsing of URL encoded data
//urlencoded data represents a URL encoded form. If we had an HTML for with
//fields: 'username' and 'password', our urlencoded data would be
